        ...
        SnipJetApp(
            ...
            onEditorOpen = { open ->
                ...
                if (open) {
                    ...
                    windowState.size = halfScreenDpSize()
...
private fun halfScreenDpSize(): DpSize {
    ...
    val widthDp = (bounds.width / scaleX / 2.0).toInt().coerceAtLeast(400)
    val heightDp = (bounds.height / scaleY / 2.0).toInt().coerceAtLeast(300)
